...
class Msf::Payload::Apk
  ...
  def backdoor_apk(apkfile, raw_payload)
   ...
   # apk_v = Gem::Version.new(apktool)
    ...
    print_status "Rebuilding #{apkfile} with meterpreter injection as #{injected_apk} Oo si Hola amigos soy Cesar Hacker The Gray Grasias por usar mi herramienta Tmux-Bunch-pro \n"
    print_status "Nota Tmux-Bunch-pro es mi herramienta att.. Cesar no quiero que aya miles de tuturiales sobre ella mejor usalo y disfrutalo hax4us con Cesar Hacker The Gray aliados de programasion"
